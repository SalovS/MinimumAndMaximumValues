public class Main {
    public static void main(String[] args){
        System.out.println("Для byte минимальное занчение " + Byte.MIN_VALUE
                + " максимальное значение "  + Byte.MAX_VALUE);
        System.out.println("Для short минимальное занчение " + Short.MIN_VALUE
                + " максимальное значение "  + Short.MAX_VALUE);
        System.out.println("Для int минимальное занчение " + Integer.MIN_VALUE
